	...
	<div class="wrapper">
		...
		<aside class="main-sidebar sidebar-dark-primary elevation-4">
			...
			<a href="index.php" class="brand-link">
				...
				<span class="brand-text"> Data Penduduk</span>
			</a>
          ...
          if ($data_level=="admin"){
        	?>
						...
						<li class="nav-item">
							<a onclick="return confirm('Anda akan keluar')" href="logout.php" class="nav-link">
      ...
      if(isset($_GET['page'])){
          ...
          switch ($hal) {
				...
				//Data Jenis kelamin
				case 'laki-laki':
					include "admin/data_laki.php";
					break;
				case 'perempuan':
					include "admin/data_perempuan.php";
					break;
