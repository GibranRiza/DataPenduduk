	...
	<form action="" method="post" enctype="multipart/form-data">
		<div class="card-body">
			...
			<div class="form-group row">
				...
				<div class="col-sm-6">
					<input type="text" class="form-control" id="alasan" name="alasan" placeholder="Alasan Pindah" value="<?php echo $data_cek['alasan']; ?>"
					 required>
				</div>
			</div>
...
<?php
    ...
    if ($query_ubah) {
      ...
      Swal.fire({title: 'Ubah Data Gagal',text: '',icon: 'error',confirmButtonText: 'OK'
        ...
        {window.location = 'index.php?page=edit-pindah';
        }
      })</script>";
    }}
