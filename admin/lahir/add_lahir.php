<div class="card card-primary">
	...
	<form action="" method="post" enctype="multipart/form-data">
		<div class="card-body">
			...
			<div class="form-group row">
				...
				<div class="col-sm-6">
					<input type="text" class="form-control" id="nama_lahir" name="nama_lahir" placeholder="Nama" required>
				</div>
			</div>
    ...
    //mulai proses simpan data
        $sql_simpan = "INSERT INTO tb_lahir (nama_lahir, tgl_lh, jekel,id_pend) VALUES (
            '".$_POST['nama_lahir']."',
			'".$_POST['tgl_lh']."',
            '".$_POST['jekel']."',
            '".$_POST['id_pend']."')";
