		...
		<table class="table">
			<tbody>
				...
				<tr>
					...
					<td>: <?php echo $data_cek['tempat_lh']; ?>
						/
				...
				<tr>
					...
					<td>: 	<?php echo $data_cek['kelurahan']; ?>, RT
				...
				<tr>
					...
					<td>: <?php echo $data_cek['pekerjaan']; ?>
					</td>
				</tr>
