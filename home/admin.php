<?php
  ...
  $sql = $koneksi->query("SELECT COUNT(id_pend) as perempuan  from tb_pdd where jekel='pr' and status='Ada'");
  while ($data= $sql->fetch_assoc()) {
    $prem=$data['perempuan'];
  }
...
<div class="row">
	...
	<div class="col-lg-3 col-6">
		...
		<div class="small-box bg-warning">
			...
			<a href="index.php?page=perempuan" class="small-box-footer">Selengkapnya
				<i class="fas fa-arrow-circle-right"></i>
			</a>
		</div>
	</div>
